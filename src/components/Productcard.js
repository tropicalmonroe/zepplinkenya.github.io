...
const Productcard = (props) => {
  ...
  return (
    ...
    className={` ${location.pathname==="/store" ? `gr-${grid}` : "col-3"} `}>
        <Link to='/SingleProduct/:id' className="product-card position-relative">

            
            <div className="product-img">
                <img src='images/bestpack5.png' className='img-fluid' alt='Best-sellers' width="450" height="350"/>
                <img src='images/bestpack1.jpg' className='img-fluid' alt='Best-sellers' width="450" height="350"/>
            </div>
        <div className="product-details">
            <h6 className='brand py-3 mt-3'>NewYorker</h6>
            <h5 className='brand-title'>MellowMonday</h5>
            <StarRatingComponent
            starCount={5}
            emptyStarColor='#000'
            value={4}

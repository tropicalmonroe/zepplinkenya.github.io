    ...
    <div className='col-3'>
        <div className="product-card">
            <div className="product-img">
                <img src='images/bestpack3.png' className='img-fluid' alt='Best-sellers' width="450" height="350"/>
                <img src='images/bestpack7.jpg' className='img-fluid' alt='Best-sellers' width="450" height="350"/>
            </div>
            <div className="product-details">
              <h6 className='brand py-3 mt-3'>Zara</h6>
              <h5 className='brand-title'>FunkyFriday</h5>
              <StarRatingComponent
              starCount={5}
              emptyStarColor='#000'
              value={4}
